...
const stats = [
  { value: '500+', label: 'Projects Completed',  sub: 'Pan-India Delivery'     },
  { value: '13+',  label: 'Years Experience',     sub: 'Since 2011'             },
  { value: '20+',  label: 'Industries Served',    sub: 'Across Key Sectors'     },
  { value: '98%',  label: 'Client Satisfaction',  sub: 'Repeat Engagement Rate' },
];
