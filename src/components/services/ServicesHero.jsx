      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="services-hero-anim">
              <span className="tag-badge">Our Services</span>
            </div>

            <h1 className="services-hero-anim text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0F1520] tracking-tight leading-[1.1] font-outfit">
              Engineering Solutions <br />
              <span className="text-[#E31E24]">Built Around You</span>
            </h1>

            <p className="services-hero-anim text-slate-600 text-base sm:text-lg max-w-xl leading-relaxed">
            ...
            <div className="services-hero-anim pt-2">
              <button
                onClick={onOpenQuote}
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative w-full h-[380px] sm:h-[460px] rounded-3xl overflow-hidden shadow-2xl border border-slate-200 group">
              <img
                src="/images/hero_plant.png"
                alt="Turbo Tech Industrial Engineering Solutions"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-out"
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-slate-950/40 via-transparent to-transparent pointer-events-none"></div>
            </div>
          </div>
