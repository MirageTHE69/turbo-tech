    ...
    <section className="relative overflow-hidden bg-white border-t border-[#E2DDD8]">
      <div className="flex flex-col lg:flex-row min-h-[320px]">
        ...
        <div className="relative flex-1 flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-14 bg-[#0F1520] overflow-hidden">
          ...
          <div className="absolute -bottom-16 -left-16 w-56 h-56 pointer-events-none"
            style={{ background: 'radial-gradient(circle, rgba(227,30,36,0.1) 0%, transparent 70%)' }}
          />

          <div className="relative z-10 max-w-lg">
            <p className="eyebrow mb-5" style={{ color: 'rgba(227,30,36,0.8)' }}>Have a Project in Mind?</p>
            <h2 className="text-3xl sm:text-4xl font-black font-outfit text-white tracking-tight leading-[1.08]">
              Partner with Turbo Tech for Reliable Engineering Solutions.
            </h2>
          </div>
        </div>
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #E31E24 0%, #C81419 100%)', minWidth: 'min(100%, 380px)' }}
        >
          ...
          <div className="relative z-10 w-full space-y-6">
            <p className="text-white/70 text-sm leading-relaxed">
              Connect with our engineering team for turnkey fabrication, piping,
              plant maintenance, and certified manpower solutions.
            </p>
            <div className="flex flex-col gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 text-white/70 text-sm font-semibold hover:text-white transition-colors"
              >
